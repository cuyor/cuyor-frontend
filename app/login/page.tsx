          ...
          <div className="mt-8">
            <div className="relative">
              ...
              <div className="relative flex justify-center text-xs">
                <span className="px-3 bg-background text-foreground/50">
                  Or continue with
                </span>
              </div>
            </div>
            ...
            <div className="mt-6 grid grid-cols-2 gap-3">
              <button className="flex items-center justify-center gap-2 px-4 py-2.5 rounded-lg border border-[--border-secondary] bg-white text-foreground text-sm font-medium hover:border-foreground/30 transition-colors">
